...
#
#   Reads a SYNTHESIZED ahb_interconnect (variant top) netlist and classifies every flop's reset as
...
#
#   ahb_interconnect builds one of three variant tops (generic / hiperf /
#   fused). DESIGN_NAME defaults to ahb_interconnect_fused and is overridable
#   via the DESIGN_NAME env var -- matching read.tcl/run_syn -- so the check
#   targets the same variant netlist that was synthesized.
#----------------------------------------------------------------------------
