...
initial
   begin
      ...
      // Writing 0xFFFFFFFF must only set the defined fields: WR_PRIV=11,
      // RD_PRIV=11, RESP=1. Reserved bits [7:4] and [31:9] read as zero.
      ...
      // The RTL coerces a 2'b10 (reserved) write of WR_PRIV / RD_PRIV
      // to 2'b11 (M-mode only) so a firmware bug cannot silently weaken
      // access control.
      ...
      // Restore the value the rest of this test (RESP=1) assumes.
      ahb_write(1, MACHINE, MDELEG,    32'h0000010F, 2,    OK);
      ...
      ahb_write(1, MACHINE,    MDELEG,    32'h0000010F, 2,    OK);
      ahb_write(1, SUPERVISOR, MDELEG,    32'h00000000, 2,    ERROR);
      ahb_write(1, USER,       MDELEG,    32'h00000000, 2,    ERROR);
      repeat(5) @(posedge free_clk);

      ahb_read( 1, MACHINE,    MDELEG,    32'h0000010F, 2, 1, OK);
      ahb_read( 1, SUPERVISOR, MDELEG,    32'h00000000, 2, 1, ERROR);
      ahb_read( 1, USER,       MDELEG,    32'h00000000, 2, 1, ERROR);
      repeat(5) @(posedge free_clk);
      ...
      $display("");
      $display(" =======================================================================");
      $display("|    MACHINE MODE: READ/WRITE-CHECK WITH-ERROR RESPONSE (always works)  |");
      $display(" =======================================================================");
      ...
      for (ii = 0; ii < 4; ii = ii + 1) begin
         for (jj = 0; jj < 4; jj = jj + 1) begin
            ...
            ahb_write(0, MACHINE, MDELEG,   {28'h0000010, ii[1:0], jj[1:0]}, 2, OK);
      ...
      $display("");
      $display(" ===============================================================");
      $display("|    SUPERVISOR MODE: READ/WRITE-CHECK WITH-ERROR RESPONSE      |");
      $display(" ===============================================================");
      ...
      for (ii = 0; ii < 4; ii = ii + 1) begin
         for (jj = 0; jj < 4; jj = jj + 1) begin
            ...
            // Predict response based on the STORED priv level, not the
            // raw value the firmware tried to write.
            ...
            if (read_resp==ERROR) begin
               ahb_read( 0, SUPERVISOR, REGIN_08,  32'h00000000, 2, 1, ERROR);
               ahb_read( 0, SUPERVISOR, REGIN_09,  32'h00000000, 2, 1, ERROR);
               ahb_read( 0, SUPERVISOR, REGIN_10,  32'h00000000, 2, 1, ERROR);
               ahb_read( 0, SUPERVISOR, REGIN_11,  32'h00000000, 2, 1, ERROR);
               ahb_read( 0, SUPERVISOR, REGIN_12,  32'h00000000, 2, 1, ERROR);
               ahb_read( 0, SUPERVISOR, REGIN_13,  32'h00000000, 2, 1, ERROR);
               ahb_read( 0, SUPERVISOR, REGIN_14,  32'h00000000, 2, 1, ERROR);
               ahb_read( 0, SUPERVISOR, REGIN_15,  32'h00000000, 2, 1, ERROR);
            end else begin
            ...
            // Read REGOUT registers
            if (read_resp==ERROR) begin
               ahb_read( 0, SUPERVISOR, REGOUT_00, 32'h00000000, 2, 1, ERROR);
               ahb_read( 0, SUPERVISOR, REGOUT_01, 32'h00000000, 2, 1, ERROR);
               ahb_read( 0, SUPERVISOR, REGOUT_02, 32'h00000000, 2, 1, ERROR);
               ahb_read( 0, SUPERVISOR, REGOUT_03, 32'h00000000, 2, 1, ERROR);
               ahb_read( 0, SUPERVISOR, REGOUT_04, 32'h00000000, 2, 1, ERROR);
               ahb_read( 0, SUPERVISOR, REGOUT_05, 32'h00000000, 2, 1, ERROR);
               ahb_read( 0, SUPERVISOR, REGOUT_06, 32'h00000000, 2, 1, ERROR);
               ahb_read( 0, SUPERVISOR, REGOUT_07, 32'h00000000, 2, 1, ERROR);
            end else begin
            ...
            // Write REGOUT registers
            ahb_write(0, SUPERVISOR, REGOUT_00, 32'h11111111, 2,    write_resp);
            ahb_write(0, SUPERVISOR, REGOUT_01, 32'h22222222, 2,    write_resp);
            ahb_write(0, SUPERVISOR, REGOUT_02, 32'h33333333, 2,    write_resp);
            ahb_write(0, SUPERVISOR, REGOUT_03, 32'h44444444, 2,    write_resp);
            ahb_write(0, SUPERVISOR, REGOUT_04, 32'h55555555, 2,    write_resp);
            ahb_write(0, SUPERVISOR, REGOUT_05, 32'h66666666, 2,    write_resp);
            ahb_write(0, SUPERVISOR, REGOUT_06, 32'h77777777, 2,    write_resp);
            ahb_write(0, SUPERVISOR, REGOUT_07, 32'h88888888, 2,    write_resp);
      ...
      $display("");
      $display(" ===============================================================");
      $display("|    USER MODE: READ/WRITE-CHECK WITH-ERROR RESPONSE            |");
      $display(" ===============================================================");
      ...
      for (ii = 0; ii < 4; ii = ii + 1) begin
         for (jj = 0; jj < 4; jj = jj + 1) begin
            ...
            // Read REGIN registers
            if (read_resp==ERROR) begin
               ahb_read( 0, USER, REGIN_08,  32'h00000000, 2, 1, ERROR);
               ahb_read( 0, USER, REGIN_09,  32'h00000000, 2, 1, ERROR);
               ahb_read( 0, USER, REGIN_10,  32'h00000000, 2, 1, ERROR);
               ahb_read( 0, USER, REGIN_11,  32'h00000000, 2, 1, ERROR);
               ahb_read( 0, USER, REGIN_12,  32'h00000000, 2, 1, ERROR);
               ahb_read( 0, USER, REGIN_13,  32'h00000000, 2, 1, ERROR);
               ahb_read( 0, USER, REGIN_14,  32'h00000000, 2, 1, ERROR);
               ahb_read( 0, USER, REGIN_15,  32'h00000000, 2, 1, ERROR);
            end else begin
            ...
            // Read REGOUT registers
            if (read_resp==ERROR) begin
               ahb_read( 0, USER, REGOUT_00, 32'h00000000, 2, 1, ERROR);
               ahb_read( 0, USER, REGOUT_01, 32'h00000000, 2, 1, ERROR);
               ahb_read( 0, USER, REGOUT_02, 32'h00000000, 2, 1, ERROR);
               ahb_read( 0, USER, REGOUT_03, 32'h00000000, 2, 1, ERROR);
               ahb_read( 0, USER, REGOUT_04, 32'h00000000, 2, 1, ERROR);
               ahb_read( 0, USER, REGOUT_05, 32'h00000000, 2, 1, ERROR);
               ahb_read( 0, USER, REGOUT_06, 32'h00000000, 2, 1, ERROR);
               ahb_read( 0, USER, REGOUT_07, 32'h00000000, 2, 1, ERROR);
            end else begin
            ...
            // Write REGOUT registers
            ahb_write(0, USER, REGOUT_00, 32'h11111111, 2,    write_resp);
            ahb_write(0, USER, REGOUT_01, 32'h22222222, 2,    write_resp);
            ahb_write(0, USER, REGOUT_02, 32'h33333333, 2,    write_resp);
            ahb_write(0, USER, REGOUT_03, 32'h44444444, 2,    write_resp);
            ahb_write(0, USER, REGOUT_04, 32'h55555555, 2,    write_resp);
            ahb_write(0, USER, REGOUT_05, 32'h66666666, 2,    write_resp);
            ahb_write(0, USER, REGOUT_06, 32'h77777777, 2,    write_resp);
            ahb_write(0, USER, REGOUT_07, 32'h88888888, 2,    write_resp);
